...
def blink_red(strikes):
    if strikes_left > 0:
        gui.configure(bg="red")
        gui.after(500, lambda: gui.configure(bg="black"))
...
def setup_phases():
    ...
    timer = Timer(component_7seg, COUNTDOWN, toggles)
...
def check_phases():
    ...
    gui._lstrikes["text"] = (f"❤" * strikes_left)
...
#play startup sound
#pygame.mixer.init()
pygame.mixer.music.load("loadingscreen.mp3")
pygame.mixer.music.play(1)
